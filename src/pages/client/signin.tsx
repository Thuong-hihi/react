...
export const Signin = () => {
  ...
  const onhanldeSubmit: SubmitHandler<IPusers> = (data: IPusers) => {
    ...
    if (data.password.length < 5) {
      setLoginError('Mật khẩu cần ít nhất 5 ký tự');
      return;
    }
      ...
      <section className="bg-white mt-[30px]">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <aside className="relative block h-16 lg:order-last lg:col-span-5 lg:h-full xl:col-span-6">
            <img
              alt="Pattern"
              src="../../../public/images/cc.jpg"
              className="absolute inset-0 w-full h-[600px] object-cover"
            />
          </aside>
          {/* <h2 className="text-center mb-[30px]">Đăng Nhập</h2> */}
          <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div className="max-w-xl lg:max-w-3xl">
              ...
              Vegan cosmetics are not tested on animals
              </p>
